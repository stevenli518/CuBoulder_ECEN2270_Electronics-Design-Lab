...
void Move_two(){
 while(enc_count_L<=2800*2&&enc_count_R<=2900*2){
...
void Move_one(){
while(enc_count_L<=2800&&enc_count_R<=2900){
  forward(pinLeftForward,pinRightForward);
  }
digitalWrite(pinRightForward,LOW);
digitalWrite(pinLeftForward,LOW); 
...
void CW90(){
  while(enc_count_L<=2000*0.5&&enc_count_R<=1900*0.5){
...
void CC90(){
while(enc_count_L<=1700*0.5&&enc_count_R<=1900*0.5){
